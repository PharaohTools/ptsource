    ...
    <div class="row">
        <div class="col-sm-4 col-md-3 sidebar">
            ...
            <div class="list-group sidebar-list">
                ...
                <a href="/index.php?control=FileBrowser&action=start&item=<?php echo $pageVars["data"]["pipeline"]["project_slug"]["value"] ; ?>" class="list-group-item">
...
<!--            <h2 class="text-uppercase text-light"><a href="/"> PTSource - Pharaoh Tools </a></h2>-->
            <div class="row clearfix no-margin">
                ...
                <form class="form-horizontal custom-form" action="/index.php?control=FileBrowser&action=show" method="POST">
                    ...
                    <script type="text/javascript" src="/Assets/FileBrowser/js/filebrowser.js"></script>

                    <div class="form-group" id="loading-holder">
                        <div class="col-sm-offset-2 col-sm-8">
                            <div class="text-center">
                                <img class="loadingImage" src="/Assets/FileBrowser/images/loading.gif" />'
                            </div>
                        </div>
                    </div>
