...
class UserOAuthKey extends Base {
    ...
    public function execute($pageVars) {
        ...
        if ($pageVars['route']['action'] === "new") {
            if($loginSession["status"] == TRUE){
                ...
                return array ("type"=>"view", "view"=>"UserOAuthKey", "pageVars"=>$this->content); }
            return array ("type"=>"view", "view"=>"UserOAuthKeyAlert", "pageVars"=>$this->content); }
        ...
        if ($pageVars['route']['action'] === "create") {
            if($loginSession["status"] == TRUE){
                ...
                $this->content["data"] = $thisModel->getData();
                return array ("type"=>"view", "view"=>"userOAuthKeyAPHAX", "pageVars"=>$this->content);  }
            return array ("type"=>"view", "view"=>"UserOAuthKeyAlert", "pageVars"=>$this->content); }
