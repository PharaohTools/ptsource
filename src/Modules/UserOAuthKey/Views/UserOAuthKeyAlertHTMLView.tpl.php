            ...
            <ul class="nav in" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li>
                            <a href="/index.php?control=UserOAuthKey&action=show" class=" hvr-curl-bottom-right">User Profile</a>
                        </li>
                        <li>
...
<link rel="stylesheet" href="/index.php?control=AssetLoader&action=show&user=UserOAuthKey&type=css&asset=usermanager.css">
