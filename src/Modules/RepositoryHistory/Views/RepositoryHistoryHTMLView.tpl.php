	...
	<div class="navbar-default col-sm-2 sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav in" id="side-menu">
				...
				<li>
					<a href="/index.php?control=RepositoryHistory&action=show " class="active  hvr-bounce-in"><i class="fa fa-bars fa-fw hvr-bounce-in"></i> All Repositories</a>
				</li>
				<!--<li>
				...
				<div role="tabpanel grid">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="all">
							...
							$i = 1;
							foreach ($pageVars["data"]["commits"] as $repositorySlug => $repositoryDetails) {
...
//                                var_dump($match_date) ;
							...
							if ($repositoryDetails["has_parents"] === true) {
							    echo '<img class="historyImage" src="/Assets/Modules/RepositoryHistory/image/tick.png" />' ; }
							else {
							    echo '<img class="historyImage" src="/Assets/Modules/RepositoryHistory/image/cross.png" />' ; }
							?>
							</div>
							<div>
							<?php
